...
WT=1000 #weight for VH error in class_weight
...
y_treinamento_VH_raw = [1 if x<=y_treinamento_lim else 0 for x in y_treinamento.T]
...
y_treinamento_VH = np.array(y_treinamento_VH)
...
print(f"X_treinamento:\n{X_treinamento}\n")
print(f"y_treinamento_VH:\n{y_treinamento_VH}\n")
print(f"X_validacao:\n{X_validacao}\n")
print(f"y_validacao_VH:\n{y_validacao_VH}\n")
